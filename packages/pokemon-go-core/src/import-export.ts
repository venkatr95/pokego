...
import type { PokemonGoCollection, PokemonGoInstance } from './types';
...
/** Web-only helper. Mobile should use expo-sharing instead. */
export function downloadText(filename: string, content: string, mime: string) {
  if (typeof document === 'undefined') {
    throw new Error('downloadText is only available in a browser environment');
  }
