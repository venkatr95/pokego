  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img src="https://images.pokemontcg.io/cardback.png" alt="Card Back" className="w-full h-full object-cover" />
        </div>
                  ...
                  {card.buddy && buddyArtUrl && (
                    <div className="absolute top-2 left-2 z-10">
                      ...
                      >
                        ...
                        <img src={buddyArtUrl} alt={card.buddy.displayName} className="w-10 h-10 object-contain" />
                      </div>
